...
//        edit.putString("defaultCaller", callInvite.getFrom());
//        edit.apply();callInvite.getFrom()
        SharedPreferences.Editor edit = preferences.edit();
                        edit.putString("defaultCaller1", callInvite.getFrom()+"");
                        edit.apply();
        String fromId = callInvite.getFrom().replace("client:", "");
        Log.d(TAG, "configCallUI fromId = "+fromId);
        
        String caller = preferences.getString(fromId, preferences.getString("defaultCaller", "ABCDEMO"));
